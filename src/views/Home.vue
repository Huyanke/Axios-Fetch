	...
	<el-row class="container">
		<el-col :span="24" class="header">
			<el-col :span="10" class="logo" :class="collapsed?'logo-collapse-width':'logo-width'">
				{{collapsed?'11':sysName}}
			</el-col>
			<el-col :span="10">
				<div class="tools" @click.prevent="collapse" :class="collapsed?'rotatey':'rotatex'">
					<i class="fa fa-align-justify"></i>
				</div>
			</el-col>
			<el-col :span="4" class="userinfo">
				<el-dropdown trigger="hover">
					<span class="el-dropdown-link userinfo-inner"><img src="/static/logo.png" /> 超级管理员</span>
...
<script>
	export default {
		...
		methods: {
            ...
            let loginType = 0;
            if(!item.hidden && loginType==0){ //0超级管理员拥有所有权限,1二级管理员，2普通管理员
                return true;
            }
